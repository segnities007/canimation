...
data class CanimationSpec(
     ...
     *
     * - `durationMs` -> `tokens.duration.short`
     ...
     */
    fun toReduced(tokens: CanimationTokens = CanimationTokens.Default): CanimationSpec =
        CanimationSpec(
     ...
     * - easing -> `tokens.easing.accelerate`
     * - durationMs -> unchanged
     */
    fun reversed(tokens: CanimationTokens = CanimationTokens.Default): CanimationSpec =
        CanimationSpec(
