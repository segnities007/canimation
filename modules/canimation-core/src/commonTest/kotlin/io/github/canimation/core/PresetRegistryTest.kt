...
class PresetRegistryTest {
    ...
    fun createFallsBackToInstalledFadeWhenRequestedPresetIsMissing() {
        PresetRegistry.withBuiltInsForTest(
    ...
    @Test
    fun builtInsRejectRegistryWithoutFadeFallback() {
        assertFailsWith<IllegalArgumentException> {
            PresetRegistry.builtIns(
                specs = mapOf(CanimationPreset.FadeUp to presetSpec(fullEnterDurationMs = 180)),
            )
        }
    }
