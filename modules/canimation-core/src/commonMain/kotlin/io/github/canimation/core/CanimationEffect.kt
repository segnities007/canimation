...
object Canimation {
    ...
    object Diagonal {
        val TopLeft = CanimationEffect(offsetX = CanimationDpRange((-30).dp, 0.dp), offsetY = CanimationDpRange((-30).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val TopRight = CanimationEffect(offsetX = CanimationDpRange(30.dp, 0.dp), offsetY = CanimationDpRange((-30).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val BottomLeft = CanimationEffect(offsetX = CanimationDpRange((-30).dp, 0.dp), offsetY = CanimationDpRange(30.dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val BottomRight = CanimationEffect(offsetX = CanimationDpRange(30.dp, 0.dp), offsetY = CanimationDpRange(30.dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val Subtle = CanimationEffect(offsetX = CanimationDpRange((-12).dp, 0.dp), offsetY = CanimationDpRange((-12).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 250)
    }
    ...
    object Shrink {
        ...
        val Rotate = CanimationEffect(scale = CanimationRange(1.4f, 1f), rotation = CanimationRange(15f, 0f), alpha = CanimationRange(0f, 1f), durationMs = 400)
        val FadeDown = CanimationEffect(scale = CanimationRange(1.2f, 1f), offsetY = CanimationDpRange((-10).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
    }

    /** Skew / tilt entry animations. */
    object Tilt {
        val Left = CanimationEffect(rotation = CanimationRange(-8f, 0f), offsetX = CanimationDpRange((-20).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val Right = CanimationEffect(rotation = CanimationRange(8f, 0f), offsetX = CanimationDpRange(20.dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val Up = CanimationEffect(rotation = CanimationRange(-5f, 0f), offsetY = CanimationDpRange((-15).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 300)
        val Down = CanimationEffect(rotation = CanimationRange(5f, 0f), offsetY = CanimationDpRange(15.dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 300)
        val Swing = CanimationEffect(rotation = CanimationRange(-15f, 0f), scale = CanimationRange(0.9f, 1f), alpha = CanimationRange(0f, 1f), durationMs = 400)
    }
    ...
    object Float {
        ...
        val ScaleUp = CanimationEffect(offsetY = CanimationDpRange(6.dp, 0.dp), scale = CanimationRange(0.97f, 1f), alpha = CanimationRange(0.6f, 1f), durationMs = 450)
    }

    /** Drop / gravity-like animations from above. */
    object Drop {
        val In = CanimationEffect(offsetY = CanimationDpRange((-50).dp, 0.dp), scale = CanimationRange(0.8f, 1f), alpha = CanimationRange(0f, 1f), durationMs = 400)
        val Heavy = CanimationEffect(offsetY = CanimationDpRange((-80).dp, 0.dp), scale = CanimationRange(1.1f, 1f), alpha = CanimationRange(0f, 1f), durationMs = 500)
        val Light = CanimationEffect(offsetY = CanimationDpRange((-20).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 300)
        val Rotate = CanimationEffect(offsetY = CanimationDpRange((-40).dp, 0.dp), rotation = CanimationRange(-20f, 0f), alpha = CanimationRange(0f, 1f), durationMs = 450)
    }
    ...
    object Rise {
        ...
        val Scale = CanimationEffect(offsetY = CanimationDpRange(40.dp, 0.dp), scale = CanimationRange(0.7f, 1f), alpha = CanimationRange(0f, 1f), durationMs = 450)
        val Rotate = CanimationEffect(offsetY = CanimationDpRange(35.dp, 0.dp), rotation = CanimationRange(10f, 0f), alpha = CanimationRange(0f, 1f), durationMs = 400)
    }

    /** Stretch-based deformation animations. */
    object Stretch {
        val Horizontal = CanimationEffect(scale = CanimationRange(0.6f, 1f), offsetX = CanimationDpRange((-20).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val Vertical = CanimationEffect(scale = CanimationRange(0.6f, 1f), offsetY = CanimationDpRange((-20).dp, 0.dp), alpha = CanimationRange(0f, 1f), durationMs = 350)
        val Both = CanimationEffect(scale = CanimationRange(0.5f, 1f), alpha = CanimationRange(0f, 1f), durationMs = 400)
        val Snap = CanimationEffect(scale = CanimationRange(0.4f, 1f), rotation = CanimationRange(-5f, 0f), alpha = CanimationRange(0f, 1f), durationMs = 300)
    }
}
