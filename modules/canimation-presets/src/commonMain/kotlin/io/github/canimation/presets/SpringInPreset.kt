...
object SpringInPreset {
    ...
    val spec = CanimationPresetSpec(
        ...
        fullExit = CanimationSpec(durationMs = 300, easing = InternalEasings.accelerate, alpha = CanimationRange(1f, 0f), scale = CanimationRange(1.0f, 0.5f)),
