 ...
 *   "button" = M3 Button visibility loop,
 *   "fab" = M3 FloatingActionButton visibility loop,
 *   "cardDemo" = M3 Card visibility loop,
 *   "chipDemo" = M3 Chip visibility loop,
 *   "dialogDemo" = tap to show/hide M3 AlertDialog,
 *   "navBarDemo" = staggered M3 NavigationBar items,
 *   "switchDemo" = M3 Switch with toggle emphasis,
 *   "checkboxDemo" = M3 Checkbox with toggle emphasis,
 *   "textFieldDemo" = M3 OutlinedTextField visibility loop,
 *   "badgeDemo" = M3 Badge with emphasis,
 *   "listItemDemo" = staggered M3 ListItem,
 *   "snackbarDemo" = M3 Snackbar visibility loop,
 *   "progressDemo" = M3 ProgressIndicator visibility loop,
 *   "sliderDemo" = M3 Slider visibility loop
 */
...
// ===== Material3 Component Helpers =====

private fun btn(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "button",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun fab(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "fab",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun cardDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "cardDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
    Card { Text("Card Content", Modifier.padding(16.dp)) }
}""",
)

private fun chipDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "chipDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun dialogDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "dialogDemo",
    codeSnippet = """CanimationVisibility(
    visible = showDialog,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun navBarDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "navBarDemo",
    codeSnippet = """// Staggered NavigationBar items
NavigationBar {
    items.forEachIndexed { i, item ->
        CanimationVisibility(
            visible = visible,
            ...
            NavigationBarItem(selected = i == 0, onClick = {}, icon = {}, label = { Text(item) })
        }
    }
}""",
)

private fun switchDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "switchDemo",
    codeSnippet = """Row(verticalAlignment = Alignment.CenterVertically) {
    Box(Modifier.canimationEmphasize(
        active = checked,
        preset = CanimationPreset.${preset.name},
    )) {
...
private fun checkboxDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "checkboxDemo",
    codeSnippet = """Box(Modifier.canimationEmphasize(
    active = checked,
    preset = CanimationPreset.${preset.name},
)) {
...
private fun textFieldDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "textFieldDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun badgeDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "badgeDemo",
    codeSnippet = """Box(Modifier.canimationEmphasize(
    active = active,
    preset = CanimationPreset.${preset.name},
)) {
...
private fun listItemDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "listItemDemo",
    codeSnippet = """// Staggered ListItems
items.forEachIndexed { i, item ->
    CanimationVisibility(
        visible = visible,
        enterPreset = CanimationPreset.${preset.name},
...
private fun snackbarDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "snackbarDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun progressDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "progressDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
private fun sliderDemo(preset: CanimationPreset, desc: String) = ExampleItem(
    preset = preset, description = desc, demoType = "sliderDemo",
    codeSnippet = """CanimationVisibility(
    visible = isVisible,
    enterPreset = CanimationPreset.${preset.name},
) {
...
val exampleCategories: List<ExampleCategory> = listOf(
    ...
    // ===== MATERIAL3 COMPONENT EXAMPLES =====
    ExampleCategory(
        id = "m3-buttons",
        title = "Animated Buttons",
        subtitle = "Material3 Button components with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            btn(CanimationPreset.Fade, "Button fades in"),
            btn(CanimationPreset.FadeUp, "Button slides up with fade"),
            btn(CanimationPreset.ScaleIn, "Button scales in"),
            btn(CanimationPreset.Pop, "Button pops in with overshoot"),
            btn(CanimationPreset.BounceIn, "Button bounces in"),
            btn(CanimationPreset.SpringIn, "Button springs in"),
            btn(CanimationPreset.SlideRight, "Button slides from left"),
            btn(CanimationPreset.ZoomIn, "Button zooms in"),
            btn(CanimationPreset.FlipIn, "Button flips in"),
            btn(CanimationPreset.ElevateIn, "Button elevates in"),
        ),
    ),
    ExampleCategory(
        id = "m3-fab",
        title = "Floating Action Buttons",
        subtitle = "FAB components with entrance & emphasis animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            fab(CanimationPreset.ScaleIn, "FAB scales in"),
            fab(CanimationPreset.Pop, "FAB pops in"),
            fab(CanimationPreset.BounceIn, "FAB bounces in"),
            fab(CanimationPreset.SpringIn, "FAB springs in"),
            fab(CanimationPreset.ZoomIn, "FAB zooms in"),
            fab(CanimationPreset.RotateIn, "FAB rotates in"),
            fab(CanimationPreset.SpinIn, "FAB spins in"),
            fab(CanimationPreset.FlipIn, "FAB flips in"),
        ),
    ),
    ExampleCategory(
        id = "m3-cards",
        title = "Animated Cards",
        subtitle = "Card components with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            cardDemo(CanimationPreset.FadeUp, "Card fades up"),
            cardDemo(CanimationPreset.ScaleIn, "Card scales in"),
            cardDemo(CanimationPreset.Pop, "Card pops in"),
            cardDemo(CanimationPreset.BounceIn, "Card bounces in"),
            cardDemo(CanimationPreset.SpringIn, "Card springs in"),
            cardDemo(CanimationPreset.SlideLeft, "Card slides from right"),
            cardDemo(CanimationPreset.ZoomIn, "Card zooms in"),
            cardDemo(CanimationPreset.ElevateIn, "Card elevates in"),
            cardDemo(CanimationPreset.FadeInLeft, "Card fades from left"),
            cardDemo(CanimationPreset.FadeInRight, "Card fades from right"),
        ),
    ),
    ExampleCategory(
        id = "m3-chips",
        title = "Animated Chips",
        subtitle = "Chip components with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            chipDemo(CanimationPreset.Fade, "Chip fades in"),
            chipDemo(CanimationPreset.FadeUp, "Chip slides up"),
            chipDemo(CanimationPreset.ScaleIn, "Chip scales in"),
            chipDemo(CanimationPreset.Pop, "Chip pops in"),
            chipDemo(CanimationPreset.BounceIn, "Chip bounces in"),
            chipDemo(CanimationPreset.SpringIn, "Chip springs in"),
            chipDemo(CanimationPreset.SlideRight, "Chip slides from left"),
            chipDemo(CanimationPreset.ZoomIn, "Chip zooms in"),
        ),
    ),
    ExampleCategory(
        id = "m3-dialog",
        title = "Animated Dialogs",
        subtitle = "Tap to show animated AlertDialog",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            dialogDemo(CanimationPreset.Fade, "Dialog fades in"),
            dialogDemo(CanimationPreset.ScaleIn, "Dialog scales in"),
            dialogDemo(CanimationPreset.ZoomIn, "Dialog zooms in"),
            dialogDemo(CanimationPreset.Pop, "Dialog pops in"),
            dialogDemo(CanimationPreset.BounceIn, "Dialog bounces in"),
            dialogDemo(CanimationPreset.SpringIn, "Dialog springs in"),
            dialogDemo(CanimationPreset.FadeUp, "Dialog slides up"),
            dialogDemo(CanimationPreset.FlipIn, "Dialog flips in"),
        ),
    ),
    ExampleCategory(
        id = "m3-nav",
        title = "Navigation Bar",
        subtitle = "NavigationBar items with staggered entrance",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            navBarDemo(CanimationPreset.FadeUp, "Nav items fade up"),
            navBarDemo(CanimationPreset.ScaleIn, "Nav items scale in"),
            navBarDemo(CanimationPreset.BounceIn, "Nav items bounce in"),
            navBarDemo(CanimationPreset.Pop, "Nav items pop in"),
            navBarDemo(CanimationPreset.SpringIn, "Nav items spring in"),
            navBarDemo(CanimationPreset.SlideUp, "Nav items slide up"),
        ),
    ),
    ExampleCategory(
        id = "m3-switch",
        title = "Animated Switches",
        subtitle = "Switch with toggle emphasis animation",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            switchDemo(CanimationPreset.Pulse, "Pulse on toggle"),
            switchDemo(CanimationPreset.HeartBeat, "Heartbeat on toggle"),
            switchDemo(CanimationPreset.Tada, "Tada on toggle"),
            switchDemo(CanimationPreset.RubberBand, "Rubber band on toggle"),
            switchDemo(CanimationPreset.Bounce, "Bounce on toggle"),
            switchDemo(CanimationPreset.ShakeX, "Shake on toggle"),
        ),
    ),
    ExampleCategory(
        id = "m3-checkbox",
        title = "Animated Checkboxes",
        subtitle = "Checkbox with toggle emphasis animation",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            checkboxDemo(CanimationPreset.Pulse, "Pulse on check"),
            checkboxDemo(CanimationPreset.HeartBeat, "Heartbeat on check"),
            checkboxDemo(CanimationPreset.Tada, "Tada on check"),
            checkboxDemo(CanimationPreset.Bounce, "Bounce on check"),
            checkboxDemo(CanimationPreset.RubberBand, "Rubber band on check"),
            checkboxDemo(CanimationPreset.Pop, "Pop on check"),
        ),
    ),
    ExampleCategory(
        id = "m3-textfield",
        title = "Animated Text Fields",
        subtitle = "OutlinedTextField with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            textFieldDemo(CanimationPreset.FadeUp, "TextField slides up"),
            textFieldDemo(CanimationPreset.ScaleIn, "TextField scales in"),
            textFieldDemo(CanimationPreset.SlideUp, "TextField slides up"),
            textFieldDemo(CanimationPreset.SpringIn, "TextField springs in"),
            textFieldDemo(CanimationPreset.Pop, "TextField pops in"),
            textFieldDemo(CanimationPreset.FadeInLeft, "TextField from left"),
        ),
    ),
    ExampleCategory(
        id = "m3-badge",
        title = "Animated Badges",
        subtitle = "Badge with attention-seeking emphasis",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            badgeDemo(CanimationPreset.Pulse, "Badge pulses"),
            badgeDemo(CanimationPreset.HeartBeat, "Badge heartbeat"),
            badgeDemo(CanimationPreset.Tada, "Badge tada"),
            badgeDemo(CanimationPreset.Bounce, "Badge bounces"),
            badgeDemo(CanimationPreset.RubberBand, "Badge rubber band"),
            badgeDemo(CanimationPreset.ShakeX, "Badge shakes"),
            badgeDemo(CanimationPreset.Pop, "Badge pops"),
            badgeDemo(CanimationPreset.Flash, "Badge flashes"),
        ),
    ),
    ExampleCategory(
        id = "m3-list",
        title = "Animated List Items",
        subtitle = "ListItem components with staggered entrance",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            listItemDemo(CanimationPreset.FadeUp, "ListItems fade up"),
            listItemDemo(CanimationPreset.ScaleIn, "ListItems scale in"),
            listItemDemo(CanimationPreset.SlideLeft, "ListItems slide from right"),
            listItemDemo(CanimationPreset.Pop, "ListItems pop in"),
            listItemDemo(CanimationPreset.SpringFadeIn, "ListItems spring fade"),
            listItemDemo(CanimationPreset.BounceIn, "ListItems bounce in"),
        ),
    ),
    ExampleCategory(
        id = "m3-snackbar",
        title = "Animated Snackbars",
        subtitle = "Snackbar with enter/exit animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            snackbarDemo(CanimationPreset.FadeUp, "Snackbar slides up"),
            snackbarDemo(CanimationPreset.SlideUp, "Snackbar slides up big"),
            snackbarDemo(CanimationPreset.ScaleIn, "Snackbar scales in"),
            snackbarDemo(CanimationPreset.Pop, "Snackbar pops in"),
            snackbarDemo(CanimationPreset.SpringIn, "Snackbar springs in"),
            snackbarDemo(CanimationPreset.BounceIn, "Snackbar bounces in"),
        ),
    ),
    ExampleCategory(
        id = "m3-progress",
        title = "Progress Indicators",
        subtitle = "Progress indicators with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            progressDemo(CanimationPreset.Fade, "Progress fades in"),
            progressDemo(CanimationPreset.FadeUp, "Progress slides up"),
            progressDemo(CanimationPreset.ScaleIn, "Progress scales in"),
            progressDemo(CanimationPreset.Pop, "Progress pops in"),
            progressDemo(CanimationPreset.SpringIn, "Progress springs in"),
            progressDemo(CanimationPreset.SlideRight, "Progress slides from left"),
        ),
    ),
    ExampleCategory(
        id = "m3-slider",
        title = "Animated Sliders",
        subtitle = "Slider with entrance animations",
        accentLabel = "M3 COMPONENT",
        examples = listOf(
            sliderDemo(CanimationPreset.Fade, "Slider fades in"),
            sliderDemo(CanimationPreset.FadeUp, "Slider slides up"),
            sliderDemo(CanimationPreset.ScaleIn, "Slider scales in"),
            sliderDemo(CanimationPreset.SpringIn, "Slider springs in"),
            sliderDemo(CanimationPreset.SlideRight, "Slider slides from left"),
            sliderDemo(CanimationPreset.Pop, "Slider pops in"),
        ),
    ),
)
